...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="${pageContext.request.contextPath}/news/update.do"
                                ...
                                <div class="row data-type">
                                    ...
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control" id="title" name="title"
                                               placeholder="请输入标题" value="${news.title}">
                                    </div>

                                    <div class="col-md-2 title">类型</div>
                                    <div class="col-md-10 data">
                                        <select class="form-control" id="newsType" name="newsType">
                                            <option value="0" selected="selected">公司新闻/Corporate News</option>
                                            <option value="1">行业新闻/Industry News</option>
                                        </select>
                                    </div>

                                    <div class="col-md-2 title">新闻简介</div>
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control" id="keywords" name="keywords"
                                               value="${news.keywords}">
                                    </div>

                                    <div class="col-md-2 title editer">新闻内容</div>
                                    <div class="col-md-10 data editer">
                                        <script id="container" type="text/plain" name="newsContent">${news.newsContent}</script>
                                    </div>

                                    <div class="col-md-2 title">封面图片</div>
                                    <div class="col-md-10 data">
                                    ...
                                    <div class="col-md-10 data text-center">
                                        <%--<button type="button" id="submitBtn" class="btn bg-maroon">保存</button>--%>
...
<script type="text/javascript">
    var ue = UE.getEditor('container', {
        ...
        initialFrameHeight: 700,//编辑器高度，默认320

...
<div class="pro-re clearfix">
    <div>
        <div class="pg-topbar">
            <h3>Current location:<a href="${pageContext.request.contextPath}/index/findAll.do?lang=1">Home</a> / Contact us</h3>
        </div>
        <div class="pg-con">
            <div class="map">
                <iframe src="${pageContext.request.contextPath}/static_en/map/map.html" title="地图"></iframe>
                <span>Map loading...</span>
            </div>
            <ul class="clearfix">
                <li><span>Address</span>: No.305, Shengxin South Road, Nanxiang Town, Jiading District, Shanghai</li>
                <li><span>Mobile phone</span>：159-2126-7053 135-2437-1656 137-9526-3469(Shipping business）</li>
                <li><span>Telephone</span>: 021-6710 8896</li>
                <li><span>E-mail</span>：contact@pipingmaster.com,penghuaijiang@yahoo.com.cn</li>
            </ul>
        </div>
    </div>
</div>

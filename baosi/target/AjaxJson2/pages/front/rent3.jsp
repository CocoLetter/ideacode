...
<div class="pro-re clearfix">
    <div class="pg-nav">
        ...
        <ul>
            <li><a href="${pageContext.request.contextPath}/business-pre/findRent1.do">冷切割机</a></li>
            <li><a href="${pageContext.request.contextPath}/business-pre/findRent2.do">发电机组</a></li>
            <li class="active"><a href="${pageContext.request.contextPath}/business-pre/findRent3.do">液压扳手</a></li>
        </ul>
    </div>
    <div class="pg-area">
        <div class="pg-topbar">
        ...
        <div class="pro-detail">
            <h1>液压扳手</h1><br/>
            <img id="yeyabanshou" style="width: 600px;height: 450px" src="${pageContext.request.contextPath}/static/images/pro/pr6-1.jpg" alt="" />
            <div class="prodetail-con">
                <p><span>产品名称：</span>液压扳手</p>
                <p><span>型　　号：</span>详见<i style="color: #0F6996">选型参数表</i></p>
                <p><span>租赁价格：</span>面议</p>
                <p><span>产品特点：</span></p>
                <p>1.扁平机身，等厚度设计使外形更小。</p>
                <p>2.高强度材料机身，重量轻，扭矩重量比大。</p>
                <p>3.输出精度±3％，精确高效。</p>
                <p>4.紧凑的圆角半径，易于在窄小空间操作。</p>
                <p>5.每行程转动27°，速度快。</p>
                <p>6.特殊表面防腐处理，适合在恶劣环境下使用。</p>
                <p>如有疑问，<a href="${pageContext.request.contextPath}/contact/findContact.do">联系我们</a></p><br>
                <img id ="yybsParamTable" style="height:auto " src="${pageContext.request.contextPath}/static/images/pro/yeyabanshou.JPG" alt=""/>
            </div>
            <a class="more" href="${pageContext.request.contextPath}/business-pre/findRent.do">返回列表</a>
        </div>
    </div>
</div>

...
<div class="pro-re clearfix">
    <div class="pg-nav">
        ...
        <ul>
            ...
            <li class="active"><a href="${pageContext.request.contextPath}/business-pre/findRent2.do?lang=1">Generator Set</a></li>
    ...
    <div class="pg-area">
        ...
        <div class="pro-detail">
            <h1>Generator Set</h1><br/>
            <img src="${pageContext.request.contextPath}/static_en/images/pro/pr5.jpg" alt="" />
            <div class="prodetail-con">
                <p><span>Product Name：</span>Generator Set</p>
                <p><span>Model：</span>Discuss personally</p>

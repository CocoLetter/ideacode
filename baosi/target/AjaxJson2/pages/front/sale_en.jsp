...
<div class="pro-re clearfix">
    <div class="pg-nav">
        ...
        <ul>
            <li><a href="${pageContext.request.contextPath}/business-pre/findEngineeringService.do?lang=1">Engineering Service</a></li>
            <li class="active"><a href=${pageContext.request.contextPath}/business-pre/findSale.do?lang=1>Equipment Sale</a></li>
    ...
    <div class="pg-area">
        <div class="pg-topbar">
            <h3>Current Locations ：<a href="${pageContext.request.contextPath}/index/findAll.do?lang=1">Home</a>&nbsp;/&nbsp;Equipment Sale</h3>
        </div>
        <div class="bussiness"><br/>
            <p>Baosi provides new equipment sales business required by pipeline construction for the majority of construction and construction units. Sales equipment mainly includes: pipe cutting (cold cutting and hot cutting) equipment, welding equipment, flange processing equipment, pipe stress relief equipment, generator set, hydraulic wrench, etc.</p>
        </div><br/>
        <div class="bussiness1">
            <ul class="clearfix">
                <li>
                    <a href="${pageContext.request.contextPath}/product-pre/toProduct.do?lang=1"><img src="${pageContext.request.contextPath}/static/images/pro/pr8.jpg" alt="" />
                        <h3>Equipment Sales-Low Clearance Split Groove Cutting Machine</h3></a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/product-pre/toProduct.do?lang=1"><img src="${pageContext.request.contextPath}/static/images/pro/pr1.jpg" alt="" />
                        <h3>Equipment Sales-Internal Expansion Beveling Machine</h3></a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/product-pre/toProduct.do?lang=1"><img src="${pageContext.request.contextPath}/static/images/pro/pr2.jpg" alt="" />
                        <h3>Equipment Sales-External Card Automatic Beveling Machine</h3></a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/product-pre/toProduct.do?lang=1"><img src="${pageContext.request.contextPath}/static/images/pro/pr4.jpg" alt="" />
                        <h3>Equipment Sales-Hinged Pipe Cutter</h3></a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/product-pre/toProduct.do?lang=1"><img src="${pageContext.request.contextPath}/static/images/pro/pr6.jpg" alt="" />
                        <h3>Equipment Sales-Hydraulic Wrench</h3></a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/product-pre/toProduct.do?lang=1"><img src="${pageContext.request.contextPath}/static/images/pro/pr7.jpg" alt="" />
                        <h3>Equipment Sales-Accessories & Consumables</h3></a>
                </li>
            </ul>
        </div>
    </div>

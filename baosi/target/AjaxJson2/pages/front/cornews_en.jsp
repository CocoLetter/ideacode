...
<div class="pro-re clearfix">
    ...
    <div class="pg-area">
                ...
                <c:forEach items="${pageInfo.list}" var="news">
                    <li>
                        <a href="${pageContext.request.contextPath}/news-pre/toCorNewsDetails.do?lang=1&id=${news.id}">
                            <div class="newsimg">
                                <img src="${pageContext.request.contextPath}/${news.url}" alt="" style="width: 200px; height: 150px"/>
                            </div>
                            <div class="newsart">
                                <h3>${news.title}</h3>
        ...
        <div class="box-tools pull-right">
            <ul class="pagination">
                <li>
                    <a href="${pageContext.request.contextPath}/news-pre/findCorNews.do?lang=1&page=1&size=${pageInfo.pageSize}">Start</a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/news-pre/findCorNews.do?lang=1&page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">Prev</a>
                </li>
                <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                    <li>
                        <a href="${pageContext.request.contextPath}/news-pre/findCorNews.do?lang=1&page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a>
                    </li>
                </c:forEach>
                <li>
                    <a href="${pageContext.request.contextPath}/news-pre/findCorNews.do?lang=1&page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}">Next</a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/news-pre/findCorNews.do?lang=1&page=${pageInfo.pages}&size=${pageInfo.pageSize}"

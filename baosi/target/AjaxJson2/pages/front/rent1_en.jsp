...
<div class="pro-re clearfix">
    <div class="pg-nav">
        ...
        <ul>
            <li class="active"><a href="${pageContext.request.contextPath}/business-pre/findRent1.do?lang=1">Cold Cutting Machine</a></li>
            <li><a href="${pageContext.request.contextPath}/business-pre/findRent2.do?lang=1">Generator Set</a></li>
            <li><a href="${pageContext.request.contextPath}/business-pre/findRent3.do?lang=1">Hydraulic Wrench</a></li>
        </ul>
    </div>
    <div class="pg-area">
        <div class="pg-topbar">
        ...
        <div class="pro-detail">
            <h1>Cold Cutting Machine</h1><br/>
            <img id="lgj" style="height: 450px;width: 600px" src="${pageContext.request.contextPath}/static_en/images/pro/pr3.jpg" alt="" />
            <div class="prodetail-con">
                <p><span>Product Name：</span>Cold Cutting Machine</p>
                ...
                <img id ="lgjParamTable" src="${pageContext.request.contextPath}/static_en/images/pro/lgj.png" alt=""/>
            </div>

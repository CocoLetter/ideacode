...
<div class="pro-re clearfix">
    <div class="pg-nav">
        ...
        <ul>
            <li class="active"><a href="${pageContext.request.contextPath}/business-pre/findEngineeringService.do">工程服务</a></li>
    ...
    <div class="pg-area">
        <div class="pg-topbar">
            <h3>当前位置：<a href="${pageContext.request.contextPath}/index/findAll.do">网站首页</a>&nbsp;/&nbsp;工程服务</h3>
        </div>
        <div class="bussiness"><br/>
            <p>宝四提供动火连头管道预制技术服务与焊接安装服务。</p>
            <p>十年来，宝四为“西气东输一线工程”、“西气东输二线工程”、“西气东输三线工程”、“中贵线天然气管道工程”、“轮南-吐鲁番支干线管道工程”、“涩宁兰输气管道工程”、“陕京二线输气管道工程”、“陕京三线输气管道工程”等国内重特大能源管道项目提供大型动火连头设备一千二百多台次，处理焊口六百多道。公司现有冷切割设备120台，加工范围DN50--DN1500；热切割设备18台，加工范围DN200-DN1800；各类进口焊机22台；持证焊工8名。</p>
        </div><br/>
        <div class="bussiness2">
            <ul class="clearfix">
                <li>
                    <img src="${pageContext.request.contextPath}/static/images/engineeringservice/0.jpg" alt="" />
                    <h3>西气东输一线工程</h3>
                </li>
                <li>
                    <img src="${pageContext.request.contextPath}/static/images/engineeringservice/1.jpg" alt="" />
                    <h3>西气东输二线工程</h3>
                </li>
                <li>
                    <img src="${pageContext.request.contextPath}/static/images/engineeringservice/2.jpg" alt="" />
                    <h3>西气东输三线工程</h3>
                </li>
                <li>
                    <img src="${pageContext.request.contextPath}/static/images/engineeringservice/3.jpg" alt="" />
                    <h3>中贵线天然气管道工程</h3>
                </li>
                <li>
                    <img src="${pageContext.request.contextPath}/static/images/engineeringservice/4.jpg" alt="" />
                    <h3>轮南-吐鲁番支干线管道工程</h3>
                </li>
                <li>
                    <img src="${pageContext.request.contextPath}/static/images/engineeringservice/5.jpg" alt="" />
                    <h3>涩宁兰输气管道工程</h3>
                </li>
            </ul>
        </div>
        <a class="more" download="cases.pdf" href="${pageContext.request.contextPath}/static/file/cases.pdf">更多案例</a>
    </div>
</div>

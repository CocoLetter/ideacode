...
<div class="pro-re clearfix">
    <div class="pg-nav">
        ...
        <ul>
            ...
            <li class="active"><a href=${pageContext.request.contextPath}/about/findCulture.do?lang=1>Enterprise Culture</a></li>
    ...
    <div class="pg-area">
        ...
        <div class="abpg-con">
            <br/>
            <h1 style="color: rgba(21, 129, 175, 1)">Sense of Worth</h1><br/>
            <p>
                Openness and Inclusiveness, Win-win Cooperation.
            </p>
            <h1 style="color: rgba(21, 129, 175, 1)">Mission</h1><br/>
            <p>
                Serving Energy Pipeline-network, Serving Global Customers.
            </p>
            <h1 style="color: rgba(21, 129, 175, 1)">Vision</h1><br/>
            <p>
                To build a Professional Integrated Service Cooperation Platform of Energy Pipeline-network.
            </p>
        </div>
    </div>
</div>

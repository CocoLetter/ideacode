...
<div class="pro-re clearfix">
    <div class="pg-nav">
        ...
        <ul>
            ...
            <li class="active"><a href="${pageContext.request.contextPath}/business-pre/findRent2.do">发电机组</a></li>
    ...
    <div class="pg-area">
        ...
        <div class="pro-detail">
            <h1>发电机组</h1><br/>
            <img src="${pageContext.request.contextPath}/static/images/pro/pr5.jpg" alt="" />
            <div class="prodetail-con">
                <p><span>产品名称：</span>发电机组</p>
                <p><span>型　　号：</span>详细型号面议</p>

...
<div class="pro-re clearfix">
    <div class="pg-nav">
        ...
        <ul>
            <li class><a href="${pageContext.request.contextPath}/news-pre/findCorNews.do?lang=1">Company News</a></li>
            <li class="active"><a href="${pageContext.request.contextPath}/news-pre/findIndNews.do?lang=1">Industry News</a></li>
        </ul>
    </div>
    <div class="pg-area">
        <div class="pg-topbar">
            <h3>Current Location: <a href="${pageContext.request.contextPath}/index/findAll.do?lang=1">Home</a>&nbsp;/&nbsp;Industry News</h3>
        </div>
        <div class="nepg-con">
            ...
            <div class="news-detail">
                ...
                <div class="nedetail-con">
                    ...
                    <br>
                    <p>Prev：<a href="${pageContext.request.contextPath}/news-pre/toIndNewsDetails.do?lang=1&id=${newsBack.id}"
                              style="color:rgba(21, 129, 175, 1)">${newsBack.title}</a></p>
                    <p>Next：<a href="${pageContext.request.contextPath}/news-pre/toIndNewsDetails.do?lang=1&id=${newsFor.id}"
                              style="color:rgba(21, 129, 175, 1)">${newsFor.title}</a></p>
                </div>
                <a class="more" href="${pageContext.request.contextPath}/news-pre/findIndNews.do?lang=1">Back to list</a>
            </div>
        </div>
    </div>
</div>

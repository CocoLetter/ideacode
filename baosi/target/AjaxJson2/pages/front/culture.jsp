...
<div class="pro-re clearfix">
    <div class="pg-nav">
        ...
        <ul>
            <li><a href=${pageContext.request.contextPath}/about/findAbout.do>公司简介</a></li>
            <li class="active"><a href=${pageContext.request.contextPath}/about/findCulture.do>企业文化</a></li>
    ...
    <div class="pg-area">
        ...
        <div class="abpg-con">
            <br/>
            <h1 style="color: rgba(21, 129, 175, 1)">价值观</h1><br/>
            <p>
                开放包容，合作共赢。(Openness and Inclusiveness, Win-win Cooperation.)
            </p>
            <h1 style="color: rgba(21, 129, 175, 1)">使命</h1><br/>
            <p>
                效力能源官网，服务全球客户。(Serving Energy Pipeline-network, Serving Global Customers.)
            </p>
            <h1 style="color: rgba(21, 129, 175, 1)">愿景</h1><br/>
            <p>
                构建国际范围的能源管网服务平台。(To build a Professional Integrated Service Cooperation Platform of Energy Pipeline-network.)
            </p>
        </div>
    </div>
</div>

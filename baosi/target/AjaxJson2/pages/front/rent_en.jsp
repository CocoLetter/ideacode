...
<div class="pro-re clearfix">
    <div class="pg-nav">
        ...
        <ul>
            ...
            <li class="active"><a href="${pageContext.request.contextPath}/business-pre/findRent.do?lang=1">Equipment Leasing</a></li>
        </ul>
    </div>
    <div class="pg-area">
        <div class="pg-topbar">
        ...
        <div class="bussiness"><br/>
            <p><p>Baosi provides equipment leasing business required by pipeline construction for the majority of construction and construction units. Leasing machines mainly include: pipeline cutting (cold cutting and hot cutting) equipment, pipeline sealing equipment, flange processing equipment, pipeline stress relief equipment, generator set, hydraulic wrench.</p></p>
        </div><br/>
        <div class="bussiness1">
            <ul class="clearfix">
                <li>
                    <a href="${pageContext.request.contextPath}/business-pre/findRent1.do?lang=1"><img src="${pageContext.request.contextPath}/static/images/pro/pr3.jpg" alt="" />
                        <h3>Equipment Leasing-Cold Cutting Machine</h3></a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/business-pre/findRent2.do?lang=1"><img src="${pageContext.request.contextPath}/static/images/pro/pr5.jpg" alt="" />
                        <h3>Equipment Leasing-Generator Set</h3></a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/business-pre/findRent3.do?lang=1"><img src="${pageContext.request.contextPath}/static/images/pro/pr6-1.jpg" alt="" />
                        <h3>Equipment Leasing-Hydraulic Wrench</h3></a>
                </li>
            </ul>
        </div>
    </div>

...
<div class="pro-re clearfix">
    <div class="pg-nav">
        ...
        <ul>
            <li><a href=${pageContext.request.contextPath}/about/findAbout.do?lang=1></a> Company Brief</li>
            <li><a href=${pageContext.request.contextPath}/about/findCulture.do?lang=1>Enterprise Culture</a></li>
            <li class="active"><a href=${pageContext.request.contextPath}/about/findManage.do?lang=1>Manage Group</a></li>
    ...
    <div class="pg-area">
        ...
        <div class="abpg-con" align="center">
            <img src="${pageContext.request.contextPath}/static_en/images/manage.png" alt="" />
        </div>
    </div>
</div>
<div class="space"></div>

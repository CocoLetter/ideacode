...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="${pageContext.request.contextPath}/image/save.do"
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="tab-form">
                                <div class="row data-type">
                                    ...
                                    <div class="col-md-2 title">图片标题</div>
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control" name="imageSlideName"
                                               placeholder="请输入标题" value="">
                                    </div>

                                    <div class="col-md-2 title">图片</div>
                                    <div class="col-md-10 data">
                                        <input type="file" name="pictureFile" id="pictureFile" placeholder="请选择图片"/>
                                    </div>

                                    <div class="col-md-2 title">状态</div>
                                    <div class="col-md-10 data">
                                        <select class="form-control" name="imageStatus">

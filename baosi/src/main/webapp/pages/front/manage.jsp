...
<div class="pro-re clearfix">
    <div class="pg-nav">
        ...
        <ul>
            ...
            <li class="active"><a href=${pageContext.request.contextPath}/about/findManage.do>管理团队</a></li>
    ...
    <div class="pg-area">
        ...
        <div class="abpg-con" align="center">
            <img src="${pageContext.request.contextPath}/static/images/manage.png" alt="" />
        </div>
    </div>
</div>
<div class="space"></div>

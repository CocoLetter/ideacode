...
<div class="pro-re clearfix">
    <div class="pg-nav">
        ...
        <ul>
            <li><a href="${pageContext.request.contextPath}/news-pre/findCorNews.do?lang=1">Company News</a></li>
            <li class="active"><a href="${pageContext.request.contextPath}/news-pre/findIndNews.do?lang=1">Industry News</a></li>
        </ul>
    </div>
    <div class="pg-area">
        <div class="pg-topbar">
            <h3>Current Location: <a href="${pageContext.request.contextPath}/index/findAll.do?lang=1">Home</a>&nbsp;/&nbsp;News</h3>
        </div>
        <div class="nepg-con">
            <ul>
                <c:forEach items="${pageInfo.list}" var="news">
                    <li>
                        <a href="${pageContext.request.contextPath}/news-pre/toIndNewsDetails.do?lang=1&id=${news.id}">
                            <div class="newsimg">
                                <img src="${pageContext.request.contextPath}/${news.url}" alt=""/>
                            </div>
                            <div class="newsart">
                                <h3>${news.title}</h3>
                                <span>Publish Time:${news.releaseDateStr}</span>
                                <p>${news.keywords}</p>
                            </div>
                        </a>
                    </li>
        ...
        <div class="box-tools pull-right">
            <ul class="pagination">
                <li>
                    <a href="${pageContext.request.contextPath}/news-pre/findIndNews.do?lang=1&page=1&size=${pageInfo.pageSize}">Start</a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/news-pre/findIndNews.do?lang=1&page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">Prev</a>
                </li>
                <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                    <li>
                        <a href="${pageContext.request.contextPath}/news-pre/findIndNews.do?lang=1&page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a>
                    </li>
                </c:forEach>
                <li>
                    <a href="${pageContext.request.contextPath}/news-pre/findIndNews.do?lang=1&page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}">Next</a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/news-pre/findIndNews.do?lang=1&page=${pageInfo.pages}&size=${pageInfo.pageSize}"
                       aria-label="Next">End</a></li>
            </ul>
        </div>
    </div>
</div>

...
<div class="pro-re clearfix">
    <div>
        <div class="pg-topbar">
            <h3>当前位置：<a href="${pageContext.request.contextPath}/index/findAll.do?lang=1">网站首页</a> / 业绩案例</h3>
        </div>
        <div class="case">
            <h1 style="font-size: 30px;color: rgba(21, 129, 175, 1)">宝四业绩</h1>
            <p>*更多案例详见<a download="cases.pdf" href="${pageContext.request.contextPath}/static/file/cases.pdf"><i>业绩案例表</i></a>。如有疑问，欢迎<a href="${pageContext.request.contextPath}/contact/findContact.do"><i>联系我们</i></a></p>
            <img src="${pageContext.request.contextPath}/static/images/case/case1.jpg" alt="certification" width="1368"/>
            <img src="${pageContext.request.contextPath}/static/images/case/case.jpg" alt="certification" width="1368"/>
            <img src="${pageContext.request.contextPath}/static/images/case/case2.jpg" alt="certification" width="1368"/>
        </div>
    </div>
</div>

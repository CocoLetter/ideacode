...
<div class="pro-re clearfix">
    <div class="pg-nav">
        ...
        <ul>
            <li class="active"><a href="${pageContext.request.contextPath}/business-pre/findRent1.do">冷切割机</a></li>
            <li><a href="${pageContext.request.contextPath}/business-pre/findRent2.do">发电机组</a></li>
            <li><a href="${pageContext.request.contextPath}/business-pre/findRent3.do">液压扳手</a></li>
        </ul>
    </div>
    <div class="pg-area">
        <div class="pg-topbar">
        ...
        <div class="pro-detail">
            <h1>冷切割机</h1><br/>
            <img id="lgj" style="height: 450px;width: 600px" src="${pageContext.request.contextPath}/static/images/pro/pr3.jpg" alt="" />
            <div class="prodetail-con">
                <p><span>产品名称：</span>冷切割机</p>
                ...
                <img id ="lgjParamTable" src="${pageContext.request.contextPath}/static/images/pro/lgj.jpg" alt=""/>
            </div>

...
<div class="pro-re clearfix">
    <div>
        <div class="pg-topbar">
            <h3>Current locations：<a href="${pageContext.request.contextPath}/index/findAll.do?lang=1">Home</a> / Applications</h3>
        </div>
        <div class="case">
            <h1 style="font-size: 30px;color: rgba(21, 129, 175, 1)">Engineering Cases</h1>
            <p>*More cases can be found in <a download="cases.pdf" href="${pageContext.request.contextPath}/static/file/cases.pdf">cases table</a>. If in doubt, welcome to <a href="${pageContext.request.contextPath}/contact/findContact.do"><i>contact us</i></a></p>
            <img src="${pageContext.request.contextPath}/static_en/images/case/case1.jpg" alt="certification" width="1368"/>
            <img src="${pageContext.request.contextPath}/static_en/images/case/case.jpg" alt="certification" width="1368"/>
            <img src="${pageContext.request.contextPath}/static_en/images/case/case2.jpg" alt="certification" width="1368"/>
        </div>
    </div>
</div>

...
<div class="pro-re clearfix">
    <div class="pg-nav">
        ...
        <ul>
            <li class><a href="${pageContext.request.contextPath}/news-pre/findCorNews.do">公司新闻</a></li>
            <li class="active"><a href="${pageContext.request.contextPath}/news-pre/findIndNews.do">行业资讯</a></li>
        </ul>
    </div>
    <div class="pg-area">
        <div class="pg-topbar">
            <h3>当前位置：<a href="${pageContext.request.contextPath}/index/findAll.do">网站首页</a>&nbsp;/&nbsp;行业资讯</h3>
        </div>
        <div class="nepg-con">
            ...
            <div class="news-detail">
                ...
                <div class="nedetail-con">
                    ...
                    <br>
                    <p>上一篇：<a href="${pageContext.request.contextPath}/news-pre/toIndNewsDetails.do?id=${newsBack.id}"
                              style="color:rgba(21, 129, 175, 1)">${newsBack.title}</a></p>
                    <p>下一篇：<a href="${pageContext.request.contextPath}/news-pre/toIndNewsDetails.do?id=${newsFor.id}"
                              style="color:rgba(21, 129, 175, 1)">${newsFor.title}</a></p>
                </div>
                <a class="more" href="${pageContext.request.contextPath}/news-pre/findIndNews.do">返回列表</a>
            </div>
        </div>
    </div>
</div>

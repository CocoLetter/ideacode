...
<div class="pro-re clearfix">
    <div class="pg-nav">
        ...
        <ul>
            <li><a href="${pageContext.request.contextPath}/news-pre/findCorNews.do">公司新闻</a></li>
            <li class="active"><a href="${pageContext.request.contextPath}/news-pre/findIndNews.do">行业资讯</a></li>
        </ul>
    </div>
    <div class="pg-area">
        <div class="pg-topbar">
            <h3>当前位置：<a href="${pageContext.request.contextPath}/index/findAll.do">网站首页</a>&nbsp;/&nbsp;新闻动态</h3>
        </div>
        <div class="nepg-con">
            <ul>
                <c:forEach items="${pageInfo.list}" var="news">
                    <li>
                        <a href="${pageContext.request.contextPath}/news-pre/toIndNewsDetails.do?id=${news.id}">
                            ...
                            <div class="newsart">
                                <h3>${news.title}</h3>
                                <span>发布时间：${news.releaseDateStr}</span>
                                <p>${news.keywords}</p>
                            </div>
                        </a>
                    </li>
        ...
        <div class="box-tools pull-right">
            <ul class="pagination">
                <li>
                    <a href="${pageContext.request.contextPath}/news-pre/findIndNews.do?page=1&size=${pageInfo.pageSize}">首页</a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/news-pre/findIndNews.do?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">上一页</a>
                </li>
                <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                    <li>
                        <a href="${pageContext.request.contextPath}/news-pre/findIndNews.do?page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a>
                    </li>
                </c:forEach>
                <li>
                    <a href="${pageContext.request.contextPath}/news-pre/findIndNews.do?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}">下一页</a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/news-pre/findIndNews.do?page=${pageInfo.pages}&size=${pageInfo.pageSize}"

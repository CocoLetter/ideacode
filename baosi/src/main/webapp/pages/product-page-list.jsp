        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList"
                            ...
                            <thead>
                            <tr>
                                <th class="text-centert" style="padding-right: 0px;">
                                    <input id="selAll" type="checkbox" class="icheckbox_square-blue">
                                </th>
                                <%--<th class="sorting_asc">ID</th>--%>
                                <th class="text-center" style="align-items: center">产品图片</th>
                                <th class="text-center" style="align-items: center">产品名称</th>
                                <th class="text-center" style="width: 60px;align-items: center">产品价格</th>
                                <th class="text-center">产品特点</th>
                                <th class="text-center" style="align-items: center">操作</th>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            <c:forEach items="${pageInfo.list}" var="product">
                                ...
                                <tr>
                                    <td><input name="ids" type="checkbox" value="${product.id}"></td>
                                        <%--<td>${product.id }</td>--%>
                                    <td class="text-center" style="vertical-align: center"><img title="${product.url }"
                                                                                                style="width: 200px; height: 150px"
                                                                                                src="${pageContext.request.contextPath}/${product.url}">
                                    <td class="text-center">${product.productName }</td>
                                    <td class="text-center">${product.productPrice }</td>
                                    <td>${product.productChar }</td>
                                    <td class="text-center">
                                        <a href="${pageContext.request.contextPath}/product/toViewProduct.do?id=${product.id}"
                                           target="_blank"  <%--新建页面打开链接--%>
                                           class="btn bg-olive btn-xs" style="width: 70px; line-height: 30px">产品预览</a>
                                        <br><br>
                                        <a href="${pageContext.request.contextPath}/product/toUpdateProduct.do?id=${product.id}"
                                           class="btn btn-primary btn-xs "
                                           style="width: 70px; line-height: 30px">产品修改</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            总共${pageInfo.pages}页,每页 <select class="form-control" id="changePageSize"
    ...
    $(document).ready(function () {
        ...
        $("#delImage").click(function () {
            ...
            if (confirm("确定要删除所有选中的项目吗？")) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/product/delProduct.do",  //传入后台地址

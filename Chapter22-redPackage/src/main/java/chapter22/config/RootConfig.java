...
@Configuration
//定义Spring 扫描的包
@ComponentScan(value= "chapter22.*", includeFilters= {@Filter(type = FilterType.ANNOTATION, value ={Service.class})})
//使用事务驱动管理器
...
password=root*/
		...
		props.setProperty("url", "jdbc:mysql://localhost:3306/maven?serverTimezone=UTC");
